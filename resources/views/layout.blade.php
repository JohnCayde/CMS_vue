...
<body>
    <div class="container-fluid bg-dark">
        <div class="w-100 d-flex justify-content-between p-2">
            ...
            <div class="py-2">
                <a href="/howto" class="m-2 px-1 text-white  text-decoration-none">How to Play</a>
                <a href="/config" class="m-2 px-4 text-white  text-decoration-none">Config</a>
                <a href="/preview" class="m-2 px-4 text-white  text-decoration-none">Preview</a>
            </div>
